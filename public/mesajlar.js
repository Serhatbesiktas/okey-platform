// --- PROFESYONEL CANLI SOHBET MODÜLÜ (TAM SÜRÜM) --- //
...
setTimeout(() => {
    ...
    // Özel Mesaj Butonunu Sütun Grubuna Ekle (En Alta)
    ...
    if(masaEkrani) {
        ...
        solGrup.insertAdjacentHTML('beforeend', `
            <button id="masaIciOzelMesajBtn" class="masa-sol-btn" style="order:3; position:relative;" onclick="document.body.style.overflow='hidden'; document.getElementById('sohbetListesiEkrani').style.display='flex';" title="Özel Mesajlar">
                ✉️
...
}, 1100); // Müzik JS'den sonra çalışması için ufak bekleme
