...
window.profilArkadasAksiyon = function() {
    ...
    if (benimArkadaslarim.includes(hedef)) {
        if (typeof window.arkadasSil === 'function') { window.arkadasSil(hedef); document.getElementById('profilEkrani').style.display='none'; }
    } else {
        if (typeof window.arkadasEkle === 'function') { window.arkadasEkle(hedef); document.getElementById('profilEkrani').style.display='none'; }
    }
};
