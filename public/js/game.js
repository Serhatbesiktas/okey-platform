...
const sortableOptions = { group: { name: 'istaka', put: (to) => to.el.children.length === 0 }, animation: 100, delay: 0, forceFallback: true, fallbackOnBody: true, fallbackTolerance: 3, ghostClass: 'sortable-ghost', dragClass: 'sortable-drag', easing: "cubic-bezier(0.25, 1, 0.5, 1)", onEnd: function() { if(typeof sesCal === 'function' && typeof sesTasKoy !== 'undefined') sesCal(sesTasKoy); } };
...
if(isKartaKutu && typeof Sortable !== 'undefined') {
    new Sortable(isKartaKutu, {
        group: { name: 'istaka', put: function (to) { return (typeof benimSiramMi !== 'undefined' && benimSiramMi) && window.elimdekiTasSayisi() === 15; }, pull: false },
