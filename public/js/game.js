...
window.masayiTemizle = function() {
    ...
    let oyunAlanObjeleri = document.getElementById('oyunAlanObjeleri'); if(oyunAlanObjeleri) oyunAlanObjeleri.style.display = 'none';
    ...
    let kasaBilgi = document.getElementById('masaKasaBilgisi'); if(kasaBilgi) kasaBilgi.style.display = 'none';
    ...
    let iskSag = document.getElementById('iskartaSag'); if(iskSag) iskSag.innerHTML = '';
    let iskSol = document.getElementById('iskartaSol'); if(iskSol) iskSol.innerHTML = '';
    let iskUst = document.getElementById('iskartaUst'); if(iskUst) iskUst.innerHTML = '';
...
window.seriDiz = function() {
    ...
    taslar.forEach((tasObj, index) => { let y = document.getElementById('y'+index); if(y) y.appendChild(tasObj.el); });
...
window.otomatikTasAt = function(tasElementi) {
    ...
    if (iskartaKutusu) {
        ...
        let isYazi = document.getElementById('iskartaYazi'); if(isYazi) isYazi.style.display = 'none';
...
const kalanTasBtn = document.getElementById('kalanTasBilgi');
if(kalanTasBtn) {
    kalanTasBtn.addEventListener('click', () => {
...
const iskartSol = document.getElementById('iskartaSol');
if(iskartSol) {
    iskartSol.addEventListener('click', function() {
...
if(isKartaKutu && typeof Sortable !== 'undefined') {
    new Sortable(isKartaKutu, {
        ...
        onAdd: function (evt) {
            gostergeHakki = false; 
            let iskYazi = document.getElementById('iskartaYazi'); if(iskYazi) iskYazi.style.display = 'none';
