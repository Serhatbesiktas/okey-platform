...
function arayuzGuncelle() {
    ...
    if(aktifKullaniciAdi && !izleyiciModu) { if(isimKutu) html = tacEki + aktifKullaniciAdi + ' <span style="color:#2ecc71;">✔</span>'; }
